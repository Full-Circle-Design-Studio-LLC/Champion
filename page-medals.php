...
<body>
  <div class="container-fluid p-0" id="page-medals">
...
<div class="awards-subnav col-12 p-0">
  <ul class="col-12 p-0">
    ...
    <li class="col-3"><a href="<?php echo get_site_url(); ?>/plaques"><img src="<?php echo get_template_directory_uri(); ?>/assets/awards/2.svg" alt="plaques" class="col-12 col-lg-6 p-0"><p>Plaques</p></a></li>
    <li class="col-3" id="active"><a href="<?php echo get_site_url(); ?>/medals"><img src="<?php echo get_template_directory_uri(); ?>/assets/awards/3.svg" alt="medals" class="col-12 col-lg-6 p-0"><p>Medals</p></a></li>
...
?>
    <?php if($i == 1) : ?>
    <a href="<?php echo $img['url']; ?>" data-lightbox="plaques"><img src="<?php echo $img['url']; ?>" alt="<?php echo $img['alt']; ?>" class="col-12 col-md-6 float-left p-0"></a>
    <?php else :?>
    <a href="<?php echo $img['url']; ?>" data-lightbox="plaques"><img src="<?php echo $img['url']; ?>" alt="<?php echo $img['alt']; ?>" class="col-4 col-md-6 float-left p-0"></a>
    <?php endif; 
    $i++; ?>
<?php
endwhile;
