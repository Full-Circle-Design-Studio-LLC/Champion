...
<div class="awards-subnav col-12 p-0">
  <ul class="col-12 p-0">
    ...
    <li class="col-3" id="active"><a href="<?php echo get_site_url(); ?>/corporate"><img src="<?php echo get_template_directory_uri(); ?>/assets/awards/4.svg" alt="corporate" class="col-12 col-lg-6 p-0"><p>Corporate</p></a></li>
