...
<body>
  <div class="container-fluid p-0" id="page-awards">
...
<div class="awards-subnav col-12 p-0">
  <ul class="col-12 p-0">
    <li class="col-3" id="active"><a href="<?php echo get_site_url(); ?>/awards"><img src="<?php echo get_template_directory_uri(); ?>/assets/awards/1.svg" alt="trophies" class="col-12 col-lg-6 p-0"><p>Trophies</p></a></li>
